<template>
    <div>
        <div class="card bg-white">
            ...
            <div class="card-body">
                <form-create-edit ref="formularioContato" action="/api/lista" :id="id" method="POST"></form-create-edit>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.verificaPermissao('lista-create','/painel/balcao');
        },
    }
</script>